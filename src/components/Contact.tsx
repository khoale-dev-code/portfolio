  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 -z-10 overflow-hidden">
        <div className="absolute top-0 right-0 w-[400px] sm:w-[600px] h-[400px] sm:h-[600px] bg-gradient-to-bl from-[#92a344]/20 to-[#677a1c]/10 rounded-full blur-3xl animate-pulse-slow" />
        <div className="absolute bottom-0 left-0 w-[350px] sm:w-[500px] h-[350px] sm:h-[500px] bg-gradient-to-tr from-[#e8e4c7]/30 to-[#92a344]/10 rounded-full blur-3xl animate-pulse-slow" style={{ animationDelay: '2s' }} />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] sm:w-[700px] h-[500px] sm:h-[700px] bg-gradient-to-r from-[#677a1c]/5 to-[#92a344]/5 rounded-full blur-3xl animate-pulse-slow" style={{ animationDelay: '4s' }} />
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className={`text-center mb-8 sm:mb-12 md:mb-16 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-extrabold mb-4 sm:mb-6 md:mb-8 leading-tight px-2">
          ...
          <p className="text-gray-700 dark:text-gray-300 text-base sm:text-lg md:text-xl lg:text-2xl max-w-3xl mx-auto leading-relaxed font-medium px-4">
        ...
        <div className="grid lg:grid-cols-5 gap-6 sm:gap-8 mb-8 sm:mb-12 md:mb-16">
          ...
          <div className="lg:col-span-2 space-y-4 sm:space-y-6">
              ...
              {contactInfo.map((info, index) => {
                ...
                return (
                  <a
                    ...
                    className="group block p-4 sm:p-6 rounded-xl sm:rounded-2xl bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl border-2 border-gray-200/50 dark:border-gray-700/50 hover:border-[#677a1c] dark:hover:border-[#a5b95b] transition-all duration-500 hover:scale-105 hover:shadow-2xl"
                  >
                    <div className="flex items-start gap-3 sm:gap-4">
                      <div 
                        className="relative p-3 sm:p-4 rounded-lg sm:rounded-xl shadow-lg group-hover:scale-110 group-hover:rotate-6 transition-all duration-500 flex-shrink-0"
                        style={{
                      ...
                      <ArrowRight className="w-4 h-4 sm:w-5 sm:h-5 text-gray-400 group-hover:text-[#677a1c] dark:group-hover:text-[#a5b95b] group-hover:translate-x-2 transition-all duration-300 flex-shrink-0" />
                    </div>
                  </a>
                );
              })}
            ...
            {/* Quick Facts */}
            <div className="p-4 sm:p-6 rounded-xl sm:rounded-2xl bg-gradient-to-br from-[#677a1c]/10 to-[#92a344]/10 border-2 border-[#677a1c]/20 dark:border-[#a5b95b]/20 backdrop-blur-sm">
              <h3 className="text-lg sm:text-xl font-bold text-gray-900 dark:text-white mb-3 sm:mb-4 flex items-center gap-2">
                <Zap className="w-4 h-4 sm:w-5 sm:h-5 text-[#677a1c] dark:text-[#a5b95b]" />
                Quick Facts
              </h3>
                ...
                {quickFacts.map((fact, index) => {
                  ...
                  return (
                    <div key={index} className="flex items-center gap-2 sm:gap-3">
                      <Icon className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#677a1c] dark:text-[#a5b95b] flex-shrink-0" />
            ...
            {/* Availability Badge */}
            <div className="p-4 sm:p-6 rounded-xl sm:rounded-2xl bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl border-2 border-gray-200/50 dark:border-gray-700/50">
            ...
            <div className="p-4 sm:p-6 rounded-xl sm:rounded-2xl bg-gradient-to-br from-indigo-500/10 to-purple-500/10 border-2 border-indigo-500/20 dark:border-purple-500/20 backdrop-blur-sm">
              <div className="flex items-start gap-2 sm:gap-3">
                <div className="p-1.5 sm:p-2 rounded-lg bg-indigo-500/20 flex-shrink-0">
          ...
          <div className="lg:col-span-3">
            <div className="relative">
              <div className="absolute -inset-1 bg-gradient-to-r from-[#677a1c] via-[#92a344] to-[#677a1c] rounded-2xl sm:rounded-3xl blur-xl opacity-20 transition-opacity duration-500" />
              
              <form onSubmit={handleSubmit} className="relative bg-white/90 dark:bg-gray-800/90 backdrop-blur-xl rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-10 shadow-2xl border-2 border-gray-200/50 dark:border-gray-700/50">
                {/* Success Message Overlay */}
                {isSubmitted && (
                  <div className="absolute inset-0 flex items-center justify-center bg-white/95 dark:bg-gray-800/95 backdrop-blur-xl rounded-2xl sm:rounded-3xl z-50">
                    <div className="text-center p-6 sm:p-8">
                      <div className="inline-flex items-center justify-center w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-gradient-to-r from-[#677a1c] to-[#92a344] mb-4 sm:mb-6 animate-bounce">
                ...
                <div className="space-y-4 sm:space-y-6">
                  {/* Error Alert */}
                  {submitError && (
                    <div className="p-3 sm:p-4 rounded-lg sm:rounded-xl bg-red-50 dark:bg-red-900/20 border-2 border-red-200 dark:border-red-800 flex items-start gap-2 sm:gap-3">
                  ...
                  <div className="grid sm:grid-cols-2 gap-4 sm:gap-6">
                    {/* Name Field */}
                    <div className="relative">
                      <label className="flex items-center gap-2 text-xs sm:text-sm font-bold text-gray-700 dark:text-gray-300 mb-2 sm:mb-3">
                        <User className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#677a1c] dark:text-[#a5b95b]" />
                        Your Name *
                      </label>
                      <input
                        type="text"
                      ...
                      />
                      {errors.name && (
                        <p className="mt-1.5 sm:mt-2 text-[10px] sm:text-xs text-red-500 font-medium flex items-center gap-1">
                    ...
                    <div className="relative">
                      <label className="flex items-center gap-2 text-xs sm:text-sm font-bold text-gray-700 dark:text-gray-300 mb-2 sm:mb-3">
                        <AtSign className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#677a1c] dark:text-[#a5b95b]" />
                        Email Address *
                      </label>
                      <input
                        type="email"
                  ...
                  <div className="relative">
                    <label className="flex items-center gap-2 text-xs sm:text-sm font-bold text-gray-700 dark:text-gray-300 mb-2 sm:mb-3">
                      <MessageSquare className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#677a1c] dark:text-[#a5b95b]" />
                      Subject (Optional)
                    </label>
                    <input
                      type="text"
                  ...
                  <div className="relative">
                    <label className="flex items-center gap-2 text-xs sm:text-sm font-bold text-gray-700 dark:text-gray-300 mb-2 sm:mb-3">
                      <MessageCircle className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#677a1c] dark:text-[#a5b95b]" />
                      Your Message *
                    </label>
                    <textarea
                      name="message"
                    ...
                    >
                      ...
                      <span className="relative flex items-center justify-center gap-2 sm:gap-3">
                        {isSubmitting ? (
                          ...
                          <>
                            Send Message
                            <Send size={20} className="sm:w-[22px] sm:h-[22px] group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform duration-300" />
                          </>
                        )}
                      </span>
                    </button>
        ...
        {/* Bottom CTA */}
        <div className="relative">
          <div className="absolute inset-0 bg-gradient-to-r from-[#677a1c] via-[#92a344] to-[#677a1c] rounded-2xl sm:rounded-3xl blur-2xl opacity-20 animate-pulse-slow" />
          
          <div className="relative p-6 sm:p-8 md:p-10 rounded-2xl sm:rounded-3xl bg-gradient-to-br from-white/90 to-[#e8e4c7]/50 dark:from-gray-800/90 dark:to-gray-900/50 backdrop-blur-xl border-2 border-[#677a1c]/30 dark:border-[#a5b95b]/30 text-center overflow-hidden">
            ...
            <div className="relative z-10">
              <Calendar className="w-8 h-8 sm:w-10 sm:h-10 mx-auto mb-3 sm:mb-4 text-[#677a1c] dark:text-[#a5b95b]" />
              ...
              <a 
                ...
                className="inline-flex items-center gap-2 px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-[#677a1c] to-[#92a344] text-white font-bold text-sm sm:text-base rounded-full hover:shadow-2xl hover:shadow-[#677a1c]/40 hover:scale-110 transition-all duration-300"
              >
